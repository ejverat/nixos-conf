...
return {
  {
    ...
    -- Deferred to Python buffers: nothing else needs it, and it used to cost
    -- ~7 ms (image.nvim included) on every start. The remote-plugin manifest is
    -- generated by the build step, so loading later still registers the host.
    ft = "python",
